<x-app-layout>
    <div class="pb-20">
        <div id="forgot-password-page" class="bg-primary px-5 md:pr-10 py-20 flex items-center md:justify-center">
            <x-auth-session-status class="mb-4" :status="session('status')" />
            <div class="forgot-password-container h-max relative flex flex-col md:flex-row bg-tertiary rounded-xl shadow-container">
