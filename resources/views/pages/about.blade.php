        ...
        <div class="mx-auto px-5 container">
            ...
            <div class="flex flex-col md:flex-row justify-center gap-8 md:gap-12">
                ...
                <div class="right-side px-4 md:px-0 w-full md:w-1/2">
                    <h2 class="text-lg md:text-2xl font-title text-white font-semibold text-left">"{{ __('Making cybersecurity accessible to everyone') }}"</h2>
                    <div class="content">
                        <div class="mt-6 md:mt-10">
                            <p class="text-white text-left">"{{ __('OmniScan, a startup founded to democratize cybersecurity, facilitates access to professional online protection tools') }}"</p>
                            <p class="text-white mt-4 text-left">{{ __('In 2024, digital threats intensify. OmniScan responds to this growing challenge with innovative and effective solutions.') }}</p>
                            ...
                            <p class="mt-10 md:mt-16 text-left font-title font-semibold text-tertiary">{{ __('At OmniScan, we believe that online security is an essential right. Join us to secure your digital space with efficiency and simplicity.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
