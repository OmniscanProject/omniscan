<form action="{{ route('language.switch') }}" method="POST" class="inline-block">
  ...
  <div class="relative inline-flex">
    ...
    <select name="language" onchange="this.form.submit()" class="border border-gray-300 text-gray-600 h-10 pl-5 bg-white hover:border-gray-400 focus:outline-none appearance-none rounded-full">
